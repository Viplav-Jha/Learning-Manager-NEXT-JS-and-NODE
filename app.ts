...
app.use(
  cors({
    ...
    credentials:true // Allow requests from any origin by default
  })
);
...
//one line route
app.use("/api/v1", userRouter,courseRouter,orderRouter,notification,analyticsRouter,layoutRouter);
