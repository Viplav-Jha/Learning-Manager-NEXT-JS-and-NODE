...
userRouter.get('/get-users',isAuthenticated,authroizeRole('admin'), getAllUsers)

userRouter.put('/get-users-role',isAuthenticated,authroizeRole('admin'), updateUserRole)

userRouter.delete('/delete-user/:id',isAuthenticated,authroizeRole('admin'), deleteUser)
